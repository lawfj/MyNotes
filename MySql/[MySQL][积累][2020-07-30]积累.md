...
# 关于timestamp默认值
1) create table t_timestemp(t timestemp);
...
6) create table(t timestemp(6));
7) create table(t timestemp(6) on update current_timestamp(6));
8) create table(t timestemp(6) default current_timestamp(6));
9) create table(t timestemp(6) default current_timestamp on update current_timestamp(6));
10) create table(t timestemp(6) default 'yyyy-mm-dd hh:mm:ss' on update current_timestamp(6));
