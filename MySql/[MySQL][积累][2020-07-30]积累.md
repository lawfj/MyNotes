...
# 关于timestamp默认值
1) create table t_ts(t timestemp);
2) create table t_ts(t timestemp on update current_timestamp);
3) create table t_ts(t timestemp default current_timestamp);
4) create table t_ts(t timestemp default current_timestamp on update current_timestamp);
5) create table t_ts(t timestemp default 'yyyy-mm-dd hh:mm:ss' on update current_timestamp);
6) create table t_ts(t timestemp(6));
7) create table t_ts(t timestemp(6) on update current_timestamp(6));
8) create table t_ts(t timestemp(6) default current_timestamp(6));
9) create table t_ts(t timestemp(6) default current_timestamp on update current_timestamp(6));
10) create table t_ts(t timestemp(6) default 'yyyy-mm-dd hh:mm:ss' on update current_timestamp(6));
