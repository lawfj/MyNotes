...
mysql>  select unix_timestamp('2020');
+------------------------+
| unix_timestamp('2020') |
+------------------------+
|               0.000000 |
...
mysql>  select unix_timestamp('2020-07-07');
+------------------------------+
| unix_timestamp('2020-07-07') |
+------------------------------+
|                   1594051200 |
+------------------------------+
1 row in set (0.00 sec)

mysql> insert t_ts value(1, unix_timestamp('2020-07-07'));
ERROR 1292 (22007): Incorrect datetime value: '1594051200' for column 't' at row 1
...
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'from t_ts' at line 1
mysql> select * from t_ts;
+------+---------------------+
| a    | t                   |
+------+---------------------+
